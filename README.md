...
- **SuperGrafx (SGX)** — SuperGrafx titles are recognised and dispatched to the second VDC. SuperGrafx support requires PSRAM. SGX emulation is **still under development**: titles may contain graphical glitches or may not run at all.
